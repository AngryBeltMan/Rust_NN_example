...
fn open_data_set() -> Result<(Vec<ImageData>, Vec<ImageAnswer>)> {
    ...
    let mut file = File::open("Data/A_Z Handwritten Data.csv").expect("could not find training set you can download it here 'https://www.kaggle.com/datasets/sachinpatel21/az-handwritten-alphabets-in-csv-format/download?datasetVersionNumber=5'");
